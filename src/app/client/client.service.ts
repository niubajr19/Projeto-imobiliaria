...
export class ClientService {
  ...
  clients: Client[] = [
    { name: 'Junior', dateOfBirth: '04/05/1999', cpf: '12345678901', profession: 'Contador', rg: '5437623', address: 'Rua Qualquer', email: 'Junior...', telephone: 111111111 ,id: ++this.lastId},
